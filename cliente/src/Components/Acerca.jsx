                    ...
                    <div className="beneficios">
                        ...
                        <div className="divs">
                            <div className="informacion" id='ben1'>
                                <h2>Misión</h2>
                                <p>Cruz Roja Mexicana es una institución humanitaria de asistencia privada, que forma parte del Movimiento Internacional de la Cruz Roja y la Media Luna Roja, dedicada a preservar la salud, la vida y aliviar el sufrimiento humano, fomentando la cultura del autocuidado en las personas y sus comunidades, a través de la acción voluntaria.</p>
                                <h2>Visión</h2>
                                <p>Somos líderes nacionales en movilización y vinculación social, a través de redes solidarias que dan respuesta a las vulnerabilidades de las personas y comunidades, con las que logramos:</p>
                                <li>Fortalecer la cultura de prevención y cuidado de la salud de las personas.</li>
                                <li>Generar capacidades comunitarias para, anticiparse, hacer frente y recuperarse ante emergencias y desastres.</li>
                                <li>Mantener nuestra posición como referentes en la atención a emergencias y desastres.</li>
                                <li>Actuando con apego a la legalidad, los Principios Fundamentales y Valores del Movimiento Internacional de la Cruz Roja y la Media Luna Roja.</li>
                            </div>
                        </div>
                    </div>
                </div>
