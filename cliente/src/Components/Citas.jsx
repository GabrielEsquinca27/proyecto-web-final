...
const Citas = ({ state, changeState }) => {
    const [error, setError] = useState("");
    const [servicio, setServicio] = useState("");
    const [serviciosDisponibles, setServiciosDisponibles] = useState([]);

    useEffect(() => {
        const servicios = ["Consulta médica", "Laboratorio clínico", "Cirugía", "Rehabilitación", "Telemedicina"];
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            console.error("¡Error al hacer la cita!");
