...
const Registrarse = ({ state, changeState }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const repeatPassword = document.getElementById("passr").value;
                        ...
                        <Formulario>
                            <div className="re-form">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="input">
                                        <img src={passw}></img>
                                        <input type="password" placeholder="Repetir contraseña" name="passr" id="passr" required/>
                                    </div>
                                    <p><span>{error}</span></p>
                                    <b><p onClick={() => changeState(false)}>Tengo cuenta</p></b>
